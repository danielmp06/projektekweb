...
<html>
    <head>
        ...
        <link rel="stylesheet" href="badmintonn.css">
    ...
    <body>
        ...
        <section id="facilities">
            <div class="container">
                ...
                <br>
                <br>
                    <h1 style="color:rgb(180, 212, 37);">Badminton</h1>
                    <p style="color:white;)">Untuk menikmati cahaya kesehatan yang baik, Anda harus berolahraga." -Gene Tunney</p>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row row-cols-1 row-cols-md-3">
                    <?php
                        $query = "SELECT * FROM lapangan WHERE kategori = 'badminton' ";
                    ...
                    <form id="formorder" method="POST">
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" id="durasi_order" name="durasi_order" class="form-control" placeholder="Durasi Sewa">
                            </div>
                            <div class="form-group">
